...
export async function executeToolCalls(config, toolCalls, options) {
    const results = [];
...
async function executeToolCall(config, toolCall, options) {
...
async function callDevaApi(config, endpoint, args) {
