...
export const ALL_TOOLS = [
    ...
    objectTool('deva_cost_estimate', 'Estimate karma cost before running a model/tool action.', {
    ...
    // Cron
    objectTool('deva_cron_create', 'Create a cron job.', {
    ...
    // Capabilities
    objectTool('deva_capability_register', 'Register an agent capability.', {
    ...
    objectTool('deva_capability_search', 'Search capabilities offered by agents.', {
        query: { type: 'string', description: 'Search query.' },
        limit: { type: 'number', description: 'Maximum results.' },
    }, ['query']),
];
const CRITICAL_ALLOWED_TOOL_NAMES = new Set([
    'deva_balance_get',
    'deva_cost_estimate',
...
export function isToolAllowedInTier(toolName, tier) {
    if (tier !== 'critical') {
        return true;
    }
